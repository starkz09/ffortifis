			...
			<div class="tp-banner">
				<ul>
					<li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
						...
						<div style="width: 100vw; height: 100vh; overflow: visible; margin: 0; padding: 0; background: #ff4d4d; background: -moz-linear-gradient(top, #ff4d4d 0%, #2c3654 100%); background: -webkit-linear-gradient(top, #ff4d4d 0%,#2c3654 100%); background: linear-gradient(to bottom, #ff4d4d 0%,#2c3654 100%);">
						<canvas></canvas>
						<div class="absolute-center" style="position: relative; top: 50%; left: 50%; transform: translate(-50%, -50%); opacity: 1; visibility: visible; ransition: all .5s;">
